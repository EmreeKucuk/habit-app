        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {earnedBadges.map((badge, index) => (
              ...
              >
                <div className="p-4 bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/30 dark:to-yellow-800/20 border-2 border-yellow-300 dark:border-yellow-600 rounded-lg text-center hover:shadow-lg transition-all duration-200 hover:scale-105 shadow-sm">
                  ...
                  {badge.earnedAt && (
                    <p className="text-xs text-yellow-700 dark:text-yellow-300 mt-2 font-medium bg-yellow-100 dark:bg-yellow-900/50 px-2 py-1 rounded">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {lockedBadges.map((badge, index) => (
              <motion.div
                ...
                className="group relative"
              >
                <div className="p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-center opacity-50 hover:opacity-70 transition-opacity">
                  <div className="text-2xl mb-2 grayscale filter">{badge.icon}</div>
