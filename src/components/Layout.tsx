...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FEFAE0] flex text-[#344E41]">
      {/* Left Sidebar */}
      <div className="w-64 bg-[#FEFAE0] fixed h-full flex flex-col hidden lg:flex border-r border-[#344E41]/10">
        {/* Website Logo */}
        <div className="p-6">
          <Link to="/dashboard" className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-[#A3B18A] rounded-xl flex items-center justify-center">
              <span className="text-[#FEFAE0] font-bold text-xl">H</span>
            </div>
            <div>
        ...
        <div className="p-4 pb-6">
          <div className="flex items-center space-x-3 p-3 rounded-xl bg-[#A3B18A] bg-opacity-20">
            <img
          ...
          <div className="mt-3 flex space-x-2">
            <button
              onClick={toggleTheme}
              className="flex-1 p-2.5 rounded-xl bg-[#344E41] bg-opacity-5 hover:bg-opacity-10 transition-colors flex justify-center items-center"
              aria-label="Toggle theme"
            >
              {theme === 'dark' ? (
                <Sun className="w-4 h-4 text-[#344E41]" />
              ) : (
                <Moon className="w-4 h-4 text-[#344E41]" />
              )}
            </button>
            <button
              onClick={logout}
              className="flex-1 p-2.5 rounded-xl bg-[#E9C46A] bg-opacity-80 hover:bg-opacity-100 transition-colors flex justify-center items-center"
            >
              <LogOut className="w-4 h-4 text-[#344E41]" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 lg:ml-64">
        {/* Top Header Bar */}
        <header className="bg-[#FEFAE0] sticky top-0 z-40 bg-opacity-90 backdrop-blur-sm">
          <div className="px-4 lg:px-12 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="lg:hidden flex items-center space-x-3">
                <button
                  onClick={toggleTheme}
                  className="p-2.5 rounded-xl bg-[#344E41] bg-opacity-5 hover:bg-opacity-10 transition-colors"
                  aria-label="Toggle theme"
                >
                  {theme === 'dark' ? (
                    <Sun className="w-5 h-5 text-[#344E41]" />
                  ) : (
                ...
                <button
                  onClick={logout}
                  className="p-2.5 rounded-xl bg-[#E9C46A] bg-opacity-80 hover:bg-opacity-100 transition-colors"
                >
                  <LogOut className="w-5 h-5 text-[#344E41]" />
                </button>
              </div>
            </div>
          </div>
