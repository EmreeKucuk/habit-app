...
const Register: React.FC = () => {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FEFAE0] p-4 font-sans">
        <div className="w-full max-w-md bg-[#FEFAE0] p-8 md:p-10 rounded-[32px] shadow-[0_8px_30px_rgb(52,78,65,0.05)] border border-[#344E41] text-center">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FEFAE0] p-4 font-sans">
      <div className="w-full max-w-md bg-[#FEFAE0] p-8 md:p-10 rounded-[32px] shadow-[0_8px_30px_rgb(52,78,65,0.05)] border border-[#344E41]">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-[#A3B18A] text-[#344E41] px-4 py-3.5 pl-12 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E9C46A] transition-all font-medium placeholder-[#344E41]/30"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full bg-[#A3B18A] text-[#344E41] px-4 py-3.5 pl-12 pr-12 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E9C46A] transition-all font-medium placeholder-[#344E41]/30"
